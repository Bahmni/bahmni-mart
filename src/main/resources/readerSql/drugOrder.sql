      ...
      FROM patient p
             INNER JOIN (SELECT
                         ...
                         FROM  encounter en
                                 ...
                                 LEFT JOIN episode_encounter ee on  ee.encounter_id = en.encounter_id
             ...
             LEFT JOIN episode_patient_program epp on  e.episode_id = epp.episode_id
             LEFT JOIN patient_program pp ON pp.patient_program_id = epp.patient_program_id
