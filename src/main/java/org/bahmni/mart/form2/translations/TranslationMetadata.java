...
public class TranslationMetadata {
    ...
    private File getTranslationsFileWithFormName() {
    ...
    private File getNormalizedTranslationsFile() {
    ...
    private File getTranslationsFileWithUuid() {
    ...
    public File getTransaltionsFile(String formName, int version) {
        this.formName = formName;
        this.formVersion = version;

        return getTranslationsFileWithUuid().exists() ? getTranslationsFileWithUuid() :
                getTranslationsFileWithFormName().exists() ? getTranslationsFileWithFormName() :
                        getNormalizedTranslationsFile();
    }
