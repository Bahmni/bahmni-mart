...
DROP TABLE IF EXISTS health_education CASCADE; CREATE TABLE health_education( id_health_education INTEGER PRIMARY KEY, patient_id INTEGER , encounter_id INTEGER , obs_datetime TIMESTAMP , date_created TIMESTAMP , date_modified TIMESTAMP , location_id INTEGER , location_name TEXT , program_id INTEGER , program_name TEXT , he_marital_status TEXT , he_highest_education_level TEXT , he_pregnancy_status TEXT );
